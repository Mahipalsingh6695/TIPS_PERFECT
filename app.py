...
# registration_collection = db["registrations"]  # New collection for registration data
...
# def save_registration_mongodb(data):
#     registration_collection.insert_one(data)

# # Load questions (same as existing code)
# def load_questions():
...
#             # Save results to MongoDB and local JSON
#             save_results_mongodb([result])  # Here you might want to append results instead of overwriting
#             save_results_local([result])

#             # Redirect to a "Thank You" page after submission
#             return redirect(url_for("thankyou", result=result['result'], rank=1))
